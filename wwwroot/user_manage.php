...
<head>
	...
	<script type="text/javascript">
		...
		function dump_one_user(userid, username, priv, depart, card, pwd, enabled, face, fpmask, tz,
		...
		function on_get_user_data(xml, op, one_step) {
			...
			if (all_user_working)
			{
				dump_one_user(userid, username, priv, depart, card, pwd, enabled, faceexist, fpmask, tz,
								userperiod_use, userperiod_start, userperiod_end);
